...
https://ci.appveyor.com/project/jonathanwj/main/branch/master[image:https://ci.appveyor.com/api/projects/status/p65gkm3qtxv3bf3x/branch/master?svg=true[Build status]]
