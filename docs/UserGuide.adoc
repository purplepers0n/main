...
* `add r/Client n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01`
* `add r/Technician n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 t/criminal`
...
e.g.`select 2`
* *Schedule* : `schedule` +
e.g. `schedule da/05/05/2018 tm/1000`
* *History* : `history`
* *Undo* : `undo`
* *Redo* : `redo`
