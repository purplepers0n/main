...
After forking the repository, links in the documentation will still point to the `se-edu/addressbook-level4` repository.
...
The *_Architecture Diagram_* given above explains the high-level design of application. Given below is a quick overview of each component.
...
The following four sections give more details of each component.
