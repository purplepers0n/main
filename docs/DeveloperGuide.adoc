...
The following fouur sections in this guide will give more details of each component.
...
The UI consists of a `MainWindow` that is made up of parts e.g.`CommandBox`, `ResultDisplay`, `ClientListPanel`,
...
Classes used by multiple components can be found in the `seedu.addressbook.commons` package.
...
image::ModelAppointmentClassDiagram.png[width="780", caption="Figure 4-13. "]
...
image::AppointmentClassDemo.png[width="500", caption="Figure 4-14. "]
...
image::AppointmentClassDemo2.png[width="500", caption="Figure 4-15. "]
...
image::AppointmentClassDemo3.png[width="500", caption="Figure 4-16. "]
...
*Logic component* +
The following sequence diagram(Figure 4-17) shows how the schedule command works. +
...
*Storage component* +
The following diagram(Figure 4-18) shows how the appointment is being stored in the addressBook. +
