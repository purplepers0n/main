...
The diagram below illustrates the overview of the appointment class.(Figure 16) +

.View the appointment class in addressbook
image::ModelAppointmentClassDiagram.png[width="800", caption="Figure 16. "]
...
The diagrams below shows the class diagram for date and time.(Figure 17) +

.Date and time class diagram snippet
image::AppointmentClassDemo.png[width="800", caption="Figure 17. "]
...
The diagram below shows the class diagram of duration.(Figure 18) +

.Duration class diagram snippet
image::AppointmentClassDemo2.png[width="800", caption="Figure 18. "]
...
The diagram below shows the class diagram of appointment.(Figure 19)

.Appoint class diagram snippet
image::AppointmentClassDemo3.png[width="800", caption="Figure 19. "]
...
==== Logic component
The following diagram shows how the schedule command works.(Figure 20) +

.Interactions inside the Logic Component for `schedule date time duration` Command

image::ScheduleLogicSequenceDiagram.png[width="800", caption="Figure 20. "]
...
==== Storage component
The following diagram shows how the appointment be stored in the addressBook.(Figure 21) +

.Stores the appointment
image::AppointmentStorageClassDiagram.png[width="800", caption="Figure 21. "]
