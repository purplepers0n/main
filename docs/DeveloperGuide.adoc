...
`UI` consists of a `MainWindow` that is made up of parts e.g.`CommandBox`, `ResultDisplay`, `ClientListPanel`,
...
* **Alternative 1 (current choice):** Save a copy of the entire address book
...
*Storage component* +
The following diagram(Figure 4-16) shows how the appointment is being stored in the addressBook. +
