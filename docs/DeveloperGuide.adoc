...
The methods to check for a valid date are implemented this ways:
...
** Cons: The lack of the knowledge about implementation make the debugging harder. In addition, you may need to create extra methods in order to perform certain functions that are not defined in the class.
// end::scheduleappt[]
