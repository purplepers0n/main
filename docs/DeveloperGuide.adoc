...
Figure 4-12 show the sequence diagram of how the add pet to client command works.

.Interaction of the Logic Component for `addpetto p/1 c/1` Command
image::addpettoclientSequence.png[width="800" caption="Figure 4-12. "]
...
image::list_pet.png[width="350" caption="Figure 4-13. "]
...
The diagram below illustrates the overview of the appointment class.(Figure 4-13) +

.View the appointment class in addressbook
image::ModelAppointmentClassDiagram.png[width="800", caption="Figure 4-13. "]

As you can see from the class diagram, there are three attributes of an appointment and each of them is implemented by an individual class.
...
The diagrams below shows the class diagram for date and time.(Figure 4-14) +

.Date and time class diagram snippet
...
The diagram below shows the class diagram of duration.(Figure 4-15) +
...
The diagram below shows the class diagram of appointment.(Figure 4-16)
...
==== Logic component
The following diagram shows how the schedule command works.(Figure 4-17) +
...
==== Storage component
The following diagram shows how the appointment be stored in the addressBook.(Figure 4-18) +
