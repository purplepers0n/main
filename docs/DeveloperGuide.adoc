...
In order to schedule an appointment, the Vet must create an appointment by specifying the date, time and duration.
    ...
    The diagram below illustrates the overview of the appointment class.(Figure 4-1)

image::ModelAppointmentClassDiagram.png[width="800", caption="Figure 4-1. "]
...
We are not using the java date and time class but implementing our self-defined classes. The reason is to check the invalidity more efficiently.
    ...
    The diagrams below shows the class diagram for date and time.(Figure 4-2)

image::AppointmentClassDemo.png[width="800", caption="Figure 4-2. "]
...
Duration +
    ...
    The diagram below shows the class diagram of duration.(Figure 4-3)

image::AppointmentClassDemo2.png[width="800", caption="Figure 4-3. "]
...
Appointment +
    ...
    The diagram below shows the class diagram of appointment.(Figure 4-4)

image::AppointmentClassDemo3.png[width="800", caption="Figure 4-4. "]
