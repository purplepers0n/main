...
This application was created by building upon an existing code base for an address book for the module CS2103T Software Engineering, and has around 15kLoC.
...
* *Minor enhancement*: Updated `list` command and created UI for list tabs and appointment display
...
** Community:
*** Reviewed PRs (with non-trivial review comments): https://github.com/CS2103JAN2018-F09-B4/main/pull/29[#29]
...
include::../UserGuide.adoc[tag=listall, leveloffset=-1]
