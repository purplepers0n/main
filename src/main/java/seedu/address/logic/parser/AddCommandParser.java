...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_PERSON_ROLE, PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL,
                        PREFIX_ADDRESS, PREFIX_TAG);

        if (!arePrefixesPresent(argMultimap, PREFIX_PERSON_ROLE, PREFIX_NAME,
        ...
        try {
            PersonRole role = ParserUtil.parseRole(argMultimap.getValue(PREFIX_PERSON_ROLE).get());
