...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() throws Exception {
        ...
        String command = " " + EditCommand.COMMAND_WORD + "  " + index.getOneBased() + "  " + ROLE_DESC_CLIENT + "  "
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + ROLE_DESC_CLIENT + NAME_DESC_BOB
        ...
        editedPerson = new PersonBuilder(personToEdit).withTags(VALID_TAG_FRIEND).buildWithRoleClient();
        assertCommandSuccess(command, index, editedPerson);

        /* Case: clear tags -> cleared */
        index = INDEX_FIRST_PERSON;
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + " " + PREFIX_TAG.getPrefix();
        editedPerson = new PersonBuilder(personToEdit).withTags().buildWithRoleClient();
        assertCommandSuccess(command, index, editedPerson);
