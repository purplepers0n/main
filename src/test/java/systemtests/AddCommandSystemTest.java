...
import static seedu.address.logic.commands.CommandTestUtil.ROLE_DESC_TECHNICIAN;
...
public class AddCommandSystemTest extends AddressBookSystemTest {
    ...
    public void add() throws Exception {
         ...
         */
        Person toAdd = AMY;
        String command = "   " + AddCommand.COMMAND_WORD + "  " + ROLE_DESC_TECHNICIAN + "  "
        ...
        command = AddCommand.COMMAND_WORD + ROLE_DESC_TECHNICIAN + NAME_DESC_BOB
        ...
        toAdd = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY)
                .withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND).build();
        command = AddCommand.COMMAND_WORD + ROLE_DESC_TECHNICIAN + NAME_DESC_AMY
        ...
        toAdd = BOB;
        command = AddCommand.COMMAND_WORD + ROLE_DESC_TECHNICIAN
        ...
        command = AddCommand.COMMAND_WORD + ROLE_DESC_TECHNICIAN + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY;
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));

        /* Case: missing phone -> rejected */
        command = AddCommand.COMMAND_WORD + ROLE_DESC_TECHNICIAN + NAME_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY;
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));

        /* Case: missing email -> rejected */
        command = AddCommand.COMMAND_WORD + ROLE_DESC_TECHNICIAN + NAME_DESC_AMY + PHONE_DESC_AMY + ADDRESS_DESC_AMY;
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));

        /* Case: missing address -> rejected */
        command = AddCommand.COMMAND_WORD + ROLE_DESC_TECHNICIAN + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY;
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));
        ...
        command = AddCommand.COMMAND_WORD + ROLE_DESC_TECHNICIAN + INVALID_NAME_DESC
                + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY;
