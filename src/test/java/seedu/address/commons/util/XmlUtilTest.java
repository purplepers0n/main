...
public class XmlUtilTest {
    ...
    public void xmlAdaptedPersonFromFile_fileWithMissingPersonField_validResult() throws Exception {
        ...
        XmlAdaptedPerson expectedPerson = new XmlAdaptedPerson(
                null, VALID_ROLE, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void xmlAdaptedPersonFromFile_fileWithInvalidPersonField_validResult() throws Exception {
        ...
        XmlAdaptedPerson expectedPerson = new XmlAdaptedPerson(
                VALID_NAME, VALID_ROLE, INVALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
        assertEquals(expectedPerson, actualPerson);
    }
    ...
    public void xmlAdaptedPersonFromFile_fileWithValidPerson_validResult() throws Exception {
        ...
        XmlAdaptedPerson expectedPerson = new XmlAdaptedPerson(
                VALID_NAME, VALID_ROLE, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
        assertEquals(expectedPerson, actualPerson);
    }
    ...
    public void saveDataToFile_validFile_dataSaved() throws Exception {
        ...
        dataToWrite = new XmlSerializableAddressBook(
                builder.withPerson(new PersonBuilder().buildWithRoleClient()).withTag("Friends").build());
